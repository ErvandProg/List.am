...
export default function Categories() {
	...
	const { productInfo } = useContext(AddContext);

	useEffect(() => {
		dataBase.yourProduct.push(productInfo);
		console.log(dataBase.yourProduct);
	}, [productInfo])
	...
	return (
		<div className='w-[100%] flex flex-col justify-center items-center'>
			...
			<div className="w-[100%] my-[12px] py-[8px]">
				<CarService data={dataBase.carService} added={dataBase.yourProduct} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<SaleOfApartments data={dataBase.saleOfApartments} added={dataBase.yourProduct} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<ApartmentsForRent data={dataBase.apartmentsForRent} added={dataBase.yourProduct} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<Urgently data={dataBase.urgently} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<CommercialRealEstateAndOfficeLeasing data={dataBase.apartmentsForRent} added={dataBase.yourProduct} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<CarRental data={dataBase.carService} added={dataBase.yourProduct} />
			</div>
			<div className="w-[100%] my-[12px] py-[8px]">
				<Urgently data={dataBase.urgently} />
			</div>
